import { e as createComponent, f as createAstro, k as renderComponent, r as renderTemplate, m as maybeRenderHead, h as addAttribute, l as renderScript } from '../../chunks/astro/server_B7r4Bv6B.mjs';
import 'piccolore';
import { g as getUserFromToken, h as hasPermission, $ as $$Layout } from '../../chunks/Layout_BZZLFtxH.mjs';
/* empty css                                    */
import { A as API_URL, c as createSong } from '../../chunks/songs_DJyb_bwy.mjs';
...
</button> <button type="button" id="btn-ai-autocomplete" title="Completar acordes con IA" class="flex items-center gap-2 bg-linear-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white text-sm font-bold py-2 px-4 rounded-full shadow-md transition-all transform hover:scale-105"> <span>✨</span> Generar acordes con IA
