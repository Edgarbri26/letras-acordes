...
const $$Roles = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "AdminLayout", $$AdminLayout, { "title": "Gesti\xF3n de Roles" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div id="roles-page" class="w-full"${addAttribute(API_URL, "data-api-url")}${addAttribute(token, "data-token")}> <div class="flex justify-between items-center mb-8"> <h1 class="text-3xl font-bold text-accent-main">
...
Guardar Cambios
</button> </div> </div> ` })} ${renderScript($$result, "/home/runner/work/cancionero-digital-frontend/cancionero-digital-frontend/src/pages/admin/roles.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/runner/work/cancionero-digital-frontend/cancionero-digital-frontend/src/pages/admin/roles.astro", void 0);

const $$file = "/home/runner/work/cancionero-digital-frontend/cancionero-digital-frontend/src/pages/admin/roles.astro";
