...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_Bytk_3nz.mjs';
import { manifest } from './manifest_YwF0wXM4.mjs';
...
const _page14 = () => import('./pages/songs/add.astro.mjs');
const _page15 = () => import('./pages/songs/edit/_id_.astro.mjs');
const _page16 = () => import('./pages/songs/print/_id_.astro.mjs');
const _page17 = () => import('./pages/songs/search/_search_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/songs/add.astro", _page14],
    ["src/pages/songs/edit/[id].astro", _page15],
    ["src/pages/songs/print/[id].astro", _page16],
    ["src/pages/songs/search/[search].astro", _page17],
...
const _args = {
    "middlewareSecret": "a7aa6fdf-34f8-4489-91e3-d0515a1ca20b",
