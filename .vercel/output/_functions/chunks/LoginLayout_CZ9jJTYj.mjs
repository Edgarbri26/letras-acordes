import { e as createComponent, f as createAstro, h as addAttribute, n as renderHead, o as renderSlot, k as renderComponent, r as renderTemplate } from './astro/server_B7r4Bv6B.mjs';
import 'piccolore';
/* empty css                         */
...
const $$LoginLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><!-- Primary Meta Tags --><title>Login</title><meta name="title" content="Login"><meta name="description" content="Login"><link rel="canonical"${addAttribute(canonicalURL, "href")}><!-- Twitter --><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"${addAttribute(Astro2.url, "content")}><meta property="twitter:title"${addAttribute(title, "content")}><meta property="twitter:description"${addAttribute(description, "content")}><meta property="twitter:image"${addAttribute(new URL(image, Astro2.url), "content")}>${renderHead()}</head> <body class="bg-bg-main text-text-main h-screen w-full flex flex-col overflow-hidden"> <main class="flex-1 w-full flex flex-col"> ${renderSlot($$result, $$slots["default"])} </main> <div class="shrink-0"> ${renderComponent($$result, "Footer", $$Footer, {})} </div> </body></html>`;
}, "C:/dev/letras y acordes/letras-acordes/src/layouts/LoginLayout.astro", void 0);
