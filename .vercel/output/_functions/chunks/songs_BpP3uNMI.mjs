const API_URL = (typeof window !== "undefined" ? "http://localhost:3000/api" : "http://localhost:3000/api");
...
export { API_URL as A, createSong as c, getSongById as g, searchSongs as s, updateSong as u };
